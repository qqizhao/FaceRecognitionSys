...
def face2database(picture_path, model_path, database_path, batch_size=90, image_size=160):
    ...
    with tf.Graph().as_default():
        with tf.Session() as sess:
            ...
            print('Number of input: %d' % len(paths))
            # Load the model
            print('Loading feature extraction model')
            ...
            print('Calculating features for input')
...
def detect_facenet(choice):
    parser = argparse.ArgumentParser()
    parser.add_argument('--weights', type=str, default='./weights/facenet.pt', help='model.pt path')
    ...
    parser.add_argument('--facenet-model-path', type=str, default='./facenet/20180402-114759',
                        help='miss facenet-model')
    parser.add_argument('--svc-path', type=str, default='./weights/SVCmodel.pkl', help='miss svc')
    parser.add_argument('--database-path', type=str, default='./weights/Database.npz', help='miss database')
